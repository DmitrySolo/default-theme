...
if (isset($arResult['ITEM']))
{
	...
	<div class="<?=($arParams['VARIANT']==9)?"productCatInline__content":"productCol__content"?>"
         data-qcontent="<?=($arParams['VARIANT']==9)?"module__productCatInline":"module__productCol"?>"
		...
		if (!$haveOffers)
		{
			$jsParams = array(
                ...
                'TEMPLATE_PATH' => $templateFolder,     // user field!
                'PARTNER_ID' => isPartnerClient(),      // user field!
				'VIEW_MODE' => $arResult['TYPE'],
				'USE_SUBSCRIBE' => $showSubscribe,
				'PRODUCT' => array(
					'ID' => $item['ID'],
                    'XML_ID' => $item['XML_ID'],                //user field!
					'NAME' => $productTitle,
		...
		else
		{
			$jsParams = array(
				...
				'PRODUCT' => array(
					'ID' => $item['ID'],
                    'XML_ID' => $item['XML_ID'],                //user field!
                    'MAX_QUANTITY' => $item['CATALOG_QUANTITY'],//user field!
					'NAME' => $productTitle,
					'DETAIL_PAGE_URL' => $item['DETAIL_PAGE_URL'],
					'MORE_PHOTO' => $item['MORE_PHOTO'],
					'MORE_PHOTO_COUNT' => $item['MORE_PHOTO_COUNT']
