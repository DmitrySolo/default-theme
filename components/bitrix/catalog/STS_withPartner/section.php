...
$arParams["ELEMENT_VIEW_FIELD"] = 'list';
...
$arExtParams['ELEMENT_VIEW_CUSTOM_'.strtoupper($arParams["ELEMENT_VIEW_FIELD"])]="bx_active";
...
if ($arParams['USE_FILTER'] == 'Y')
{
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        ($arParams["ELEMENT_VIEW_FIELD"] == 'tiles')?"sts_withpartner_filter":"new_filter",
		Array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
...
$intSectionID = $APPLICATION->IncludeComponent(
    ...
    ($arParams["ELEMENT_VIEW_FIELD"] == 'tiles')?"section_tiles":".default",$newArParams,$component);
?><?
if ($verticalGrid)
{
    ?></div>
