...
window.BX_SetPlacemarks_<?echo $arParams['MAP_ID']?> = function (map)
{
    //$('#baloon-content').html($('.baloon-res>div').eq(0).html());//Additional code
...
?>
    ...
    <?//$APPLICATION->IncludeComponent("orangerocket:city_info_baloon", "", Array())?>
    <div id="baloon-content"></div>
<div class="bx-yandex-view-layout">
	<div class="bx-yandex-view-map">
<?
$APPLICATION->IncludeComponent('bitrix:map.yandex.system', 'feature', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
<?
